...
- Doku-Worker: pflegt nur Modul-READMEs sowie `docs/architecture.md` und `docs/documentation.md`
...
Die Root-`README.md` bleibt aus dem Loop heraus; der Doku-Worker darf stattdessen nur `discounter-backend/README.md`, `discounter-cli/README.md` und `discounter-frontend/README.md` anfassen.
Bei echten Feature-, Verhaltens- oder lokalen Ablaufänderungen in Backend, CLI oder Frontend darf der Doku-Worker nicht `DOCS_UNCHANGED` liefern.
Reine Dependency-, Build- oder Lockfile-Änderungen ohne neue Bedien- oder Laufauswirkung erzwingen keine Doku.
